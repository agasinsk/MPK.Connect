...
// public DiscreteHarmonySearcherTest() { _objectiveFunction = new
// TravelingSalesmanObjectiveFunction(); _harmonySearcher = new
// HarmonySearcher<INode>(_objectiveFunction, HarmonyMemorySize, 10000); }
